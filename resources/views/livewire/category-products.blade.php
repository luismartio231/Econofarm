...
<div wire:init="loadPosts">
    ...
    <div class="text-center mt-20">
        {{-- <div role="status">
            <svg class="inline mr-2 w-15 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

...
<x-jet-action-section>
    ...
    <x-slot name="description">
        Aquí encontrará todas los departamentos agregadas
    </x-slot>
...
<x-jet-dialog-modal wire:model="editForm.open">
 ...
 @push('script')
        <script>
            Livewire.on('deleteDepartment', DepartmentdId => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.department-component', 'delete',  DepartmentdId)
